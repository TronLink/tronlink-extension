...
class AccountsPage extends React.Component {
    ...
    render() {
        ...
        const usdt = {...accounts.selected.tokens.smart[CONTRACT_ADDRESS.USDT],imgUrl:'https://s2.coinmarketcap.com/static/img/coins/64x64/825.png',income:'2.34',price:usdt_price,tokenId:CONTRACT_ADDRESS.USDT};
        ...
        return (
            <div className='accountsPage' onClick={()=>{
                ...
                <div className="space-controller">
                    <Toast />
                    {
                      nodes.selected === 'f0b1e38e-7bee-485e-9d3f-69410bf30681' && news.length > 0 && id !==0 && (!setting.advertising[id] || (setting.advertising[id] && setting.advertising[id][mode])) ?
