        ...
        return (
            account ?
                <div className='resource'>
                    ...
                    <div className={'cell'+(nodes.selected === 'f0b1e38e-7bee-485e-9d3f-69410bf00000' || nodes.selected === 'f0b1e38e-7bee-485e-9d3f-69410bf30682'?' bankSingle':'')} onClick={ () => {
                        //PopupAPI.changeState(APP_STATE.TRONBANK);
                        if(nodes.selected === 'f0b1e38e-7bee-485e-9d3f-69410bf00000' || nodes.selected === 'f0b1e38e-7bee-485e-9d3f-69410bf30682')
                            window.open('http://www.tronlending.org');
                    }}>
                        <div className='title'>
                            {
                                nodes.selected === 'f0b1e38e-7bee-485e-9d3f-69410bf00000' || nodes.selected === 'f0b1e38e-7bee-485e-9d3f-69410bf30682' ?
        ...
        return (
            <div className='accountsPage' onClick={() => {
                ...
                <div className='space-controller'>
                    {
                        nodes.selected === 'f0b1e38e-7bee-485e-9d3f-69410bf00000' && id !== 0 && (!setting.advertising[ id ] || (setting.advertising[ id ] && setting.advertising[ id ][ mode ])) ?
